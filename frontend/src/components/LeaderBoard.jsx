...
import { Rocket, Trophy, Medal, Crown, AlertCircle } from "lucide-react";
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center">
          <div className="text-center">
            <div className="bg-[#FDF6EC]/10 backdrop-blur-xl border-2 border-[#FF6B6B]/40 rounded-2xl p-8 shadow-2xl relative">
              <div className="text-[#FF6B6B] text-xl mb-4 font-heading"><AlertCircle/> Guild Archives Unavailable</div>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div className="text-center flex-1">
              ...
              <p className="text-[#D7CCC8] text-xl">Witness the legendary masters of the craft!</p>
            </div>
            <button
              onClick={() => navigate('/')}
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              {index === 0 && (
                                <Crown
                                  size={22}
                                  className="mr-3 text-[#FFD700] drop-shadow-[0_0_6px_rgba(255,215,0,0.6)]"
                                />
                              )}
                              {index === 1 && (
                                <Medal
                                  size={22}
                                  className="mr-3 text-[#C0C0C0] drop-shadow-[0_0_6px_rgba(192,192,192,0.5)]"
                                />
                              )}
                              ...
                              {index === 2 && (
                                <Medal
                                  size={22}
                                  className="mr-3 text-[#CD7F32] drop-shadow-[0_0_6px_rgba(205,127,50,0.5)]"
                                />
                              )}

                              <span
                                className={`text-lg font-bold ${isTopThree ? rankColors[index] : 'text-[#C9A227]'
                                  }`}
                              >
                                #{index + 1}
                              </span>
          ...
          <div className="text-center mt-8">
            <div className="bg-[#FDF6EC]/8 backdrop-blur-xl border-2 border-[#C9A227]/30 rounded-2xl p-6 shadow-lg shadow-[#4E342E]/30 mb-6">
              ...
              <button
                ...
                className="group  mx-auto flex items-center gap-1 bg-gradient-to-r from-[#C9A227] to-[#B8941F] text-[#1C1C1C] font-bold px-8 py-3 rounded-full 
              ...
              >
                ...
                <Rocket size={20} />  Begin Your Ascension
              </button>
            </div>
          </div>
        </div>
